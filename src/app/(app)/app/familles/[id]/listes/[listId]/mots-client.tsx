        ...
        {!adding ? (
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="rounded border border-slate-300 px-3 py-2 text-sm text-slate-700 dark:border-slate-600 dark:text-slate-300"
            >
              Annuler
            </button>
          </div>
            ...
            {editingId === m.id ? (
              <>
                ...
                <button
                  ...
                  className="rounded border border-slate-300 px-2 py-1 text-sm text-slate-600 dark:border-slate-600 dark:text-slate-400"
                >
                  Annuler
                </button>
              </>
